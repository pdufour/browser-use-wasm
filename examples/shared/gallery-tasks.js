...
/** @typedef {{ id: string; name: string; goal: string; url: string; tag: string; hue?: string; previewId?: string }} GalleryTask */

/** Static card thumbnail (generated by `npm run cache:previews`). */
export function galleryPreviewSrc(task) {
  return withBase(`shared/previews/${task.previewId ?? task.id}.jpg`);
}
...
export function allHomeExamples() {
  return [
    ...
    { ...GEMMA_NANO_TASK, href: withBase('gemma-nano/'), accent: true },
